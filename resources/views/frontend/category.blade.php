                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                            <td>
                                                <div class="img">
                                                    <img src='images/{{ $val->image }}' alt="Image"></a>
                                                    <p>{{ $val->name}}</p>
                                                </div>
                                            </td>
                                            
                                            <td><input type="text" class="price" readonly value="{{ $val->price}}" readonly /></td>
                                            
                                                   <td>
                                                        <input type="text" class="quantity" value="1" />
                                                    </td>
                                            
                                            <td><input type="text" class="total" readonly  class="readonly" /></td>
                                            <td><button><a href="delete/{{$val->id}}"><i class="fa fa-trash"></i></button></a></td>
                                        </tr>
                                    </tbody>
                                    @endforeach
                                </table>
